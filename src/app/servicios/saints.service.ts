...
export class SaintsService {
  ...
  // ]
  ListadoCaballeros:Saints[] = [];
  public rutaApi: string = "https://apisuperligafifa.herokuapp.com/testing/saintseiya2"
  ...
  Add(caballeros:Saints[]){
    this.ListadoCaballeros = caballeros;
  }

  CaballerosListaOwn():Saints[]{
    return this.ListadoCaballeros.slice();
  }
